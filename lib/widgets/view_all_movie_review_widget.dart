...
class ViewAllMovieReviewWidget extends StatelessWidget {
  final List<Review> movieReviewList;

  const ViewAllMovieReviewWidget({Key key, this.movieReviewList}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    int numberOfReviews = movieReviewList.length;
    return Scaffold(
      appBar: AppBar(
              ...
              child: Container(
                ...
                child: movieReviewList.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        separatorBuilder: (BuildContext context, int index) => Divider(thickness: 2.0),
                      ),
                ),
              ),
            );
