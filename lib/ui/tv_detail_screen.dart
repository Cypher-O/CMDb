...
import 'package:CMDb/widgets/view_all_tvshow_review_widget.dart';
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => VideoPlayerScreen(
                                        videoUrl:
                                            'https://www.youtube.com/watch?v=${tvShowDetail.trailerId}',
                                      ),
                                    ),
                                  );
                                },
                  ...
                  actions: [
                    Consumer<WatchlistModel>(
                      builder: (context, watchlistModel, child) {
                        bool isAdded = watchlistModel.tvShowWatchlist
                            .contains(widget.tvShow);
                          ...
                          onTap: () {
                            setState(() {
                              if (isAdded) {
                                ...
                                watchlistModel
                                    .addToWatchlistTvShow(widget.tvShow);
                              }
                            });
                          },
                          child: Padding(
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ViewAllTvShowReviewWidget(
                  ...
                  BlocBuilder<TvShowReviewBloc, TvShowReviewState>(
                    builder: (context, state) {
                      if (state is TvShowReviewLoading) {
                        ...
                        tvShowReviewList = state.tvShowReviewList;
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                              scrollDirection: Axis.horizontal,
                              itemCount:
                                  tvShowDetail.productionCompanies.length,
                              itemBuilder: (context, index) {
                                final company =
